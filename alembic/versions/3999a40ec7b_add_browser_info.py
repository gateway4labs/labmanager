...
def upgrade():
    ...
    op.add_column('UseLogs', sa.Column('browser_language', sa.Unicode(length=10), nullable=True))
    op.add_column('UseLogs', sa.Column('browser_name', sa.Unicode(length=15), nullable=True))
    op.add_column('UseLogs', sa.Column('browser_platform', sa.Unicode(length=15), nullable=True))
    op.add_column('UseLogs', sa.Column('browser_version', sa.Unicode(length=10), nullable=True))
